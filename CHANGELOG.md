...
### Additions
- Added `magneticHeading`, `trueHeading`, and `headingAccuracy` to `IONGLOCPositionModel`.
- Added support for compass heading in both `requestSingleLocation` and monitoring flows using `CLHeading`.
